export default {
  ...
  keys: {
    ...
    customKeyPlaceholder: 'Enter your custom key (min 6 chars)',
    customKeyHint: 'Only letters, numbers, underscores and hyphens allowed. Minimum 6 characters.',
    customKeyTooShort: 'Custom key must be at least 6 characters',
    ...
    revealKey: 'Show key',
    hideKey: 'Hide key',
    editKeyLabel: 'API Key',
    editKeyHint: 'Changing this value updates the key used for authentication. Leave unchanged to keep the current key.',
